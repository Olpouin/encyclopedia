...
if (!isset($data['default_language'])) exit(APIresponse('servererror', $langAPI['isset']."default_language"));
if (!isset($data['site_name'])) exit(APIresponse('servererror', $langAPI['isset']."site_name"));
if (!isset($data['box-default_image'])) exit(APIresponse('servererror', $langAPI['isset']."box-default_image"));

if (!$checkPassword($data['pass'])) exit(APIresponse('error',$langAPI['error-pass']));

if (!array_key_exists($data['default_language'], $config['lang'])) exit(APIresponse('servererror', $langAPI['errorserv-lang']));
